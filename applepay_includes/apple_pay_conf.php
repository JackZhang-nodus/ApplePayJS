...
define('PRODUCTION_CERTIFICATE_KEY', getcwd() . '/applepay_includes/test.key.pem');
define('PRODUCTION_CERTIFICATE_PATH', getcwd() . '/applepay_includes/test.crt.pem');
...
define('PRODUCTION_MERCHANTIDENTIFIER', 'merchant.com.heartland.test');
